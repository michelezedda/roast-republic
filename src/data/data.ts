const cards = [
  ...
  },
  {
    ...
    description: "",
    menu: [
      { id: 0, title: "Espresso", price: "$ 3.75" },
      { id: 1, title: "Double Espresso", price: "$ 4.5" },
      { id: 2, title: "Cortado", price: "$ 4.5" },
      { id: 3, title: "Americano", price: "$ 3.75" },
      { id: 4, title: "Cappuccino", price: "$ 4.5" },
      { id: 5, title: "Flat White", price: "$ 6" },
      { id: 6, title: "Latte", price: "$ 6.75" },
      { id: 7, title: "Cold Brew", price: "$ 5.25" },
      { id: 8, title: "Chai Latte", price: "$ 7" },
      { id: 9, title: "Matcha Latte", price: "$ 7" },
    ],
    syrups: [
      { id: 0, title: "Vanilla", price: "+ $ 1" },
      { id: 1, title: "Hazelnut", price: "+ $ 1" },
      { id: 2, title: "Pistachio", price: "+ $ 1.25" },
